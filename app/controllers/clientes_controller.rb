  ...
  private
    ...
    def notice_a_mostrar(string_notificacion, string_nuevo_u_update)
      ...
      when "REPLEGAL"
        ...
        notice_asociacion_nuevo_cliente_a_replegal_existente
    ...
    def rfc_ya_tiene_rep_legal_notice
      "Ese RFC ya está dado de alta como representante legal. Para darlo de alta como cliente
    ...
    def notice_asociacion_nuevo_cliente_a_replegal_existente
      "El cliente se creó exitosamente y está asociado al representante legal " +
